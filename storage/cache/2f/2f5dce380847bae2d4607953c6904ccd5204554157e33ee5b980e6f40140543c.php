...
class __TwigTemplate_fc9ab976da0aa01e9d45e2e909311420aada24d8e378eceffd6318261f4f205f extends Twig_Template
{
...
\t\t\t\t\t  <td class=\"text-center\">";
        ...
        if (((isset($context["sort"]) ? $context["sort"] : null) == "p.price")) {
            ...
            echo twig_lower_filter($this->env, (isset($context["order"]) ? $context["order"] : null));
            echo "\">";
            echo (isset($context["column_price2"]) ? $context["column_price2"] : null);
            echo "</a> ";
        } else {
            echo " <a href=\"";
            echo (isset($context["sort_price"]) ? $context["sort_price"] : null);
...
\t\t\t\t\t  <td class=\"text-right\"><a href=\"";
                ...
                if ($this->getAttribute($context["product"], "special", array())) {
                    echo " <span style=\"text-decoration: line-through;\">";
                    echo $this->getAttribute($context["product"], "price2", array());
                    echo "</span><br/>
                ...
                $context['_seq'] = twig_ensure_traversable((isset($context["categories"]) ? $context["categories"] : null));
                foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
                    if (twig_in_filter($this->getAttribute($context["category"], "category_id", array()), $this->getAttribute($context["product"], "category", array()))) {
                        echo $this->getAttribute($context["category"], "name", array());
                        echo "<br>";
                    }
                }
...
";
    ...
    {
        return array (  716 => 325,  696 => 308,  673 => 288,  658 => 276,  607 => 228,  603 => 227,  595 => 221,  589 => 218,  586 => 217,  583 => 216,  573 => 212,  557 => 211,  543 => 210,  538 => 207,  532 => 206,  527 => 204,  520 => 202,  516 => 200,  510 => 199,  505 => 197,  498 => 195,  492 => 192,  480 => 191,  474 => 190,  471 => 189,  465 => 188,  459 => 186,  457 => 185,  453 => 183,  448 => 182,  446 => 181,  421 => 173,  403 => 172,  399 => 171,  379 => 168,  360 => 166,  341 => 164,  337 => 163,  333 => 162,  324 => 156,  318 => 153,  307 => 145,  295 => 135,  284 => 127,  276 => 121,  265 => 113,  257 => 107,  254 => 106,  243 => 98,  235 => 92,  224 => 84,  216 => 78,  214 => 77,  202 => 68,  194 => 65,  190 => 64,  182 => 61,  178 => 60,  170 => 57,  166 => 56,  158 => 53,  154 => 52,  149 => 49,  143 => 48,  135 => 46,  127 => 44,  124 => 43,  120 => 42,  114 => 39,  105 => 33,  99 => 29,  91 => 25,  88 => 24,  80 => 20,  78 => 19,  73 => 16,  62 => 14,  58 => 13,  53 => 11,  44 => 9,  38 => 8,  32 => 7,  28 => 6,  19 => 1,);
    }
}
/* {{ header }}{{ column_left }}*/
/* <div id="content">*/
...
/* */
/*                       <td class="text-right">{% if sort == 'p.price' %} <a href="{{ sort_price }}" class="{{ order|lower }}">{{ column_price2 }}</a> {% else %} <a href="{{ sort_price }}">{{ column_price2 }}</a> {% endif %}</td>*/
/* */
/*                       <!-- Filter By Category -->*/
...
/*                       {% endif %}</td>*/
/* */
/*                       <td class="text-right">{% if product.special %} <span style="text-decoration: line-through;">{{ product.price2 }}</span><br/>*/
/* */
/*                         <div class="text-danger">{{ product.special }}</div>*/
/*                         {% else %}*/
/*                         {{ product.price2 }}*/
