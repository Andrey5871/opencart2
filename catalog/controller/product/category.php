...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		if (isset($this->request->get['searchModelAuto'])) {
						...
						foreach ($getModyfi->rows as $key => $valueModify) {
							$arrayModyfi[] = array(
								...
								'href' => $this->url->link('product/search', "searchMarkaAuto=".$this->request->get['searchMarkaAuto']."&searchModelAuto=". $valueModelAuto['idModel']."&searchModify=".$valueModify['id'])
							);
		...
		$category_info = $this->model_catalog_category->getCategory($category_id);
				$data['parentId'] = $category_info['parent_id'];
				$data['categoryId'] = $category_info['category_id'];
		if ($category_info) {
